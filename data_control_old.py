...
class ImageData:
    ...
    def get_img_data():
        ...
        pose_pitch = 0
        n = 0
        for obj in MongoClient("mongodb+srv://Wen:[PASSWORD]@cluster0-gvhmp.mongodb.net/test?retryWrites=true&w=majority").interview.users.find():
            n += 1
...
#added over n_count for smile
        mydict = {'smile': smile_count / n_count,
